...
public class Taxform {
	...
	public Taxform(int form_id, int taxpayer_id, int year, String address, String city, String province,
			String postalcode, String martial_status, double employment_income, double other_income,
			double capital_gains_losses, double income_taxes_paid, double total_rrsp, double cpp, double ei,
			Date tax_filing_date) {
		super();
	...
	public void setEmployment_income(double employment_income) {
		this.employment_income = employment_income;
	}
	...
	public void setCapital_gains_losses(double capital_gains_losses) {
		this.capital_gains_losses = capital_gains_losses;
	}
	...
	public void setTotal_rrsp(double total_rrsp) {
		this.total_rrsp = total_rrsp;
	}
